@echo off
REM ================================================================================
REM Document Manager V2.3 - Production Launcher
REM ================================================================================
REM
REM This launcher works from both:
REM   - Local development (running from code directory)
REM   - Network deployment (running from \\SERVER\Apps\DocumentManager\)
REM
REM It automatically finds Python and launches the application.
REM ================================================================================

echo.
echo ================================================================================
echo Document Manager V2.3 - PRODUCTION
echo ================================================================================
echo.
...
echo   3. Edit this START_APP.bat file
...
echo Starting Document Manager V2.3...
echo.
echo --------------------------------------------------------------------------------
echo.
